namespace Spiegel_VN {
  export async function Chp04_E_ExamineMirror(): ƒS.SceneReturn {
    ...
    await ƒS.Speech.tell(characters.maincharacter, "Du willst dir nochmal Kailanis Schlafzimmer und den Spiegel genauer anschauen. Und vielleicht findest du doch eine Spur von ihr.");
        await ƒS.Speech.tell(characters.maincharacter, "Das Zimmer ist so still. Du schaust dich um. Eigentlich fühlst du dich unwohl, hier zu sein, weil Kailanis Privatsphäre ihr sehr am Herzen liegt und sie bestimmt etwas dagegen hätte, wenn du durch ihre Sachen schnüffelst.");
