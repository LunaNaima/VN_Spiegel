...
await ƒS.Character.show(characters.Mama, characters.Mama.pose.pants2_angry2, ƒS.positionPercent(80, 100));
    ...
    switch (Chp04TalkFamilyElement) {
      ...
      case Chp04TalkFamilyElementAnswers.iSayMirror:
        ...
        await ƒS.Speech.tell(characters.Mama, '"Warum gehen wir nicht zu Anna und fragen sie nach ihrem Sohn? Stell dir vor, wir machen hier ein großes Drama und später spazieren die beiden seelenruhig zur Tür rein."');
