    ...
    do {
      ...
      switch (Chp08ConvoFlynnElement) {
        case Chp08ConvoFlynnElementAnswers.iSayExploreTheyAreAfraid:
          ...
          await ƒS.Speech.tell(characters.maincharacter, '"Angst vor Verurteilung! Wenn jemand anders aussieht, als die Leute in Whary, werden sie von ihnen verurteilt. Nur, weil sie nicht schlank genug oder keine Muskeln an der richtigen Stelle haben. Das ist doch kein schönes Gefühl."');
        ...
        case Chp08ConvoFlynnElementAnswers.iSayExploreAll:
          ...
          await ƒS.Character.show(characters.Flynn, characters.Flynn.pose.pos2_crossed_angry, ƒS.positionPercent(50, 100));
          ƒS.update();
          await ƒS.Speech.tell(characters.maincharacter, '"Ich glaube, wenn es manche vormachen, wollen es alle anderen nachmachen. So hat der Koch das gesagt! Manche haben die Farbe zuerst bekommen, dann wollten sie alle anderen auch."');
        ...
        case Chp08ConvoFlynnElementAnswers.iSayContinue:
          ...
          ƒS.update();
          await ƒS.update(transitions.fade.duration, transitions.fade.alpha, transitions.fade.edge);
          await ƒS.Speech.tell(characters.maincharacter, "Euer Boot driftet näher an die Häuser heran, die direkt am Ufer des Sees stehen. Du reibst dir die Augen, aber – alles ist grau! Du schaust an dir herunter – auch grau. Einzig der Turm, der bedrohlich in die Höhe ragt, ist in knallorange.");
